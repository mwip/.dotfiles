...
** COMMENT =swiper=
   ...
   -- ditched since evil is standard search now
   #+BEGIN_SRC emacs-lisp
     (use-package swiper
       :ensure try
...
#+end_src
** COMMENT Overwrite highlighted text
   #+begin_src emacs-lisp
...
** COMMENT Auto-completion for file names
   #+BEGIN_SRC emacs-lisp
...
** Pyvenv
   #+begin_src emacs-lisp
     (use-package pyvenv
       :ensure t
       :init
       (setenv "WORKON_HOME" "/home/loki/miniconda3/envs")
