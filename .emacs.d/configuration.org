...
** Font
   #+BEGIN_SRC emacs-lisp
   ;;(add-to-list 'default-frame-alist '(font . "Code New Roman Nerd Font Complete Mono 12" ))
   (add-to-list 'default-frame-alist '(font . "CodeNewRomanNerdFontCompleteM Nerd Font 12" ))
   (set-face-attribute 'default t :font "CodeNewRomanNerdFontCompleteM Nerd Font 12" )
...
** Languagetool support
   ...
   #+begin_src emacs-lisp
     (use-package languagetool
       ...
       :config
       (setq languagetool-mother-tongue "de")
       (setq languagetool-disabled-rules
             '("WHITESPACE_RULE"
               "LEERZEICHEN_VOR_AUSRUFEZEICHEN_ETC"
               "CURRENCY_SPACE"
               "PLUS_MINUS"
...
** Highlight trailing whitespace
   ...
   #+end_src
** Ledger Mode / Beancount
   Use beancount mode instead: https://github.com/beancount/beancount-mode
   #+begin_src emacs-lisp
...
** Python mode
   #+begin_src emacs-lisp
     ...
     ; use virtualenvironment for more up-to-date python & pylsp
     ; create more up-to-date environment
     ; conda create -n pylsp python=3.10
     ; conda activate pylsp
     ; pip install python-lsp-server python-lsp-ruff pylsp-mypy pylsp-rope
     (require 'lsp-pylsp)
     (setq lsp-pylsp-server-command "~/miniforge3/envs/pylsp/bin/pylsp")
     (setq lsp-pylsp-plugins-ruff-enabled t)
     (setq lsp-pylsp-plugins-flake8-enabled nil)
     (setq lsp-pylsp-plugins-pycodestyle-enabled nil)
     (setq lsp-pylsp-plugins-pyflakes-enabled nil)
     (setq lsp-pylsp-plugins-mccabe-enabled nil)
     (setq lsp-pylsp-plugins-pyls_isort-enabled nil)
   #+end_src
** Elpy for black formatting on save
   #+begin_src emacs-lisp
     (use-package elpy
       :ensure t
       :config
...
*** Often used files
    #+begin_src emacs-lisp
    (define-key mymap (kbd "f m") (lambda  () "myorg" (interactive) (find-file "~/myorg.org")))
...
** More evil-leader
   #+begin_src emacs-lisp
     ...
     (evil-leader/set-key "ll" 'languagetool-server-mode)
     (evil-leader/set-key "lc" 'languagetool-correct-buffer)
     (evil-leader/set-key "lp" 'languagetool-correct-at-point)
